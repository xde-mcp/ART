...
configs["0.7.3"] = {
    "art_location": "git+https://github.com/OpenPipe/ART.git@main",
    "run_script": "uv run logprob_check.py",
}
...
configs["0.7.2-tool-calls"] = {
    "art_location": "git+https://github.com/OpenPipe/ART.git@vllm_0_7_2_new_unsloth",
    "run_script": "uv run logprob_check_tool_calls.py",
}

configs["0.8.3-tool-calls"] = {
    "art_location": "git+https://github.com/OpenPipe/ART.git@vllm_0_8_3_new_unsloth",
    "run_script": "uv run logprob_check_tool_calls.py",
}

configs["0.8.0-rc1-tool-calls"] = {
    "art_location": "git+https://github.com/OpenPipe/ART.git@vllm_0_8_0_rc1_new_unsloth",
    "run_script": "uv run logprob_check_tool_calls.py",
}
