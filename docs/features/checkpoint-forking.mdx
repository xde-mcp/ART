...
<Note>
This feature is marked as experimental (`_experimental_fork_checkpoint`) because we're still refining the API shape. However, the core functionality will remain stable.
</Note>
...
## Example: Experimenting with Learning Rates
