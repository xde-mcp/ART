...
**MCP•RL** enables you to train agents to effectively use any MCP (Model Context Protocol) server with minimal setup. Simply provide an MCP server URL and MCP•RL will automatically:
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **MCP•RL**         | [🏋️ Train agent](https://colab.research.google.com/github/openpipe/art/blob/art-mcp/examples/mcp-rl/mcp_rl.ipynb)            | Qwen 2.5 14B masters Alphavantage financial data | <img src="https://github.com/openpipe/art/raw/art-mcp/assets/benchmarks/mcp_alphavantage/accuracy-training-progress.svg" height="72"> [benchmarks](/examples/mcp-rl/mcp_rl/benchmarks/display_benchmarks/mcp_alphavantage.ipynb) |
