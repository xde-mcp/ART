...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **MCP•RL**         | [🏋️ Train agent](https://colab.research.google.com/github/openpipe/art/blob/main/examples/mcp-rl/mcp_rl.ipynb)               | Qwen 2.5 14B learns to research Alphavantage financial data | <img src="https://github.com/openpipe/art/raw/main/assets/benchmarks/mcp_alphavantage/accuracy-training-progress.svg" height="72"> [benchmarks](/examples/mcp-rl/mcp_rl/benchmarks/display_benchmarks/mcp_alphavantage.ipynb) |
